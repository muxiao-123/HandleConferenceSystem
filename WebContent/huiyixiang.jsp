			...
			<div class="jumbotron col-md-8 col-md-offset-2">
			 	...
			 	<div class="col-md-5 col-md-offset-1 hidden" id="baoMing">
			 		<div style="background-color: rgba(96,96,96,0.1)">
			 			<form action="hhhh" method="post" class="form-horizontal" >
			 				<!--保证获取id-->
			 				<div class="hidden">
			 					<input type="text" placeholder="会议id从当前信息页面获" value="${meet3.getMeet_id() }" name="meet_id" />
			 					<input type="text" placeholder="用户id从session获得" value="${att.getAid() }" name="aid" />
			 				</div>
			 				
			 				<div class="form-group">
			 				    <label class="control-label">您的姓名</label>
			 				<div >
			 					<input type="text" required autofocus placeholder="请输入您的姓名" class="form-control" name="a_userName" />
			 				</div>
			 				</div>
			 				...
			 				<div class="form-group">
			 					...
			 					<div class="">
			 						<input type="email" required class="form-control" name="a_email" />
			 					</div>
			 				</div>
